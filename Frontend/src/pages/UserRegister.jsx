    ...
    <div className=" flex flex-col h-screen justify-between p-7">
      ...
      <div>
        <p className="text-[10px] leading-tight ">
          This site is protected by reCAPTCHA and the Google Privacy Policy and the <span className="underline" >Google privacy policy</span> and <span className="underline" >Term of service policy</span>
        </p>
      </div>
    </div>
  );
